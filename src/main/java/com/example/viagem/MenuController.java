...
public class MenuController {
    ...
    public void mudaTelaUsuario(ActionEvent event) throws IOException{
       Parent root = FXMLLoader.load(getClass().getClassLoader().getResource("cadastraUsuario-view.fxml"));
       stage = (Stage) ((Node)event.getSource()).getScene().getWindow();
       scene = new Scene(root);
       stage.setScene(scene);
       stage.show();
    }
    public void mudaTelaMenu(ActionEvent event) throws IOException{
